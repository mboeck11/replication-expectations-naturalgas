...
This page contains the replication files for Boeck, M. and Zörner, T. O. (2024) *Natural Gas Prices, Inflation Expectations, and the Pass-Through to Euro Area Inflation*, Energy Economics, Vol. 141, 108061, pp. 1-14.

In order to reproduce all the graphics visible in the paper, just run **main.r** in the *scripts* folder. Estimations are based on 25.000 MCMC draws where the first 15.000 are discarded. Hence, the script takes a considerable amount of time to run through. The number of saved draws (*draws*) and discarded draws (*burnins*) can be adapted by the user. Results are obtained using a Mac computer (mac OS Sequoia 15.1) and R 4.4.2. The script then reproduces the following
...
**Links:** [(Journal Publication)](https://doi.org/10.1016/j.eneco.2024.108061) [(Latest Version Sept 2024)](https://mboeck11.github.io/papers/BZ2024ENEC.pdf)
